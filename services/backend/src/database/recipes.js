...
function insertRecipe(recipe) {
    return __awaiter(this, void 0, void 0, function () {
        var database, insertedId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, mongo_1.getDatabase)()];
                case 1:
                    database = _a.sent();
                    if (!(database !== null)) return [3 /*break*/, 3];
                    return [4 /*yield*/, database.collection(collectionName).insertOne(recipe)];
                case 2:
